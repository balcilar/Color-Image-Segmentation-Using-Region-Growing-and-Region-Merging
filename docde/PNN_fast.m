function T = PNN_fast(Iseg,nhist,nseg)
...
histnum = sum(nhist,1);
qlv = size(nhist,1);
tmp = repmat(histnum,qlv,1);
phist = nhist./tmp;
%dist between phist
distv = pdist(phist','euclidean');%probably KL distance is a better choice, use method in the paper here.
